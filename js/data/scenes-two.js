...
export const SCENES_TWO = [
  ...
  },
  {
    ...
    alt: {
      ...
      text: 'Вместо длинных анкет и сторонних сайтов — прямое целевое действие.',
      icon: 'flag',
      question: 'Как клиенту проще завершить шаг?',
      options: [
        option('alt-action-now', 'Завершить действие в 1 клик', 'zap', 'Целевое действие в 1 клик', {}, 'Готово! Без перехода на сторонние сайты и ожидания.'),
        option('alt-action-short', 'Оставить контакт без лишних полей', 'smartphone', 'Минимум полей', {}, 'Быстрый ввод без регистраций и длинных анкет.'),
      ],
    },
  },
  {
